...
- The resulting tidy dataset contains 17284 observations and 12 columns. Columns include date of observation (year, month), area information (metro, state_name, city_name), county information (county_name, county_fips), region information (neighborhood, zip_code, region_id, size_rank), and ZORI data (zori).
